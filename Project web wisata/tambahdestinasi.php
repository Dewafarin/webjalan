...
<body>
    ...
    <div class="container">
        <form method="post" enctype="multipart/form-data">
            <h1>DESTINASI BARU<h1>
            <div class="allinput">
                <div class="content1">
                    <div class="input">
                        <div class="label"><i class="fas fa-fw fa-umbrella-beach"></i></div><input type="text" name="nama" placeholder="Nama..." > 
                    </div>
                    <div class="input">
                        <div class="label"><i class="fas fa-fw fa-map-marker-alt"></i></div><input type="text" name="lokasi" placeholder="Kota..." > 
                    </div>
                    <div class="input">
                        <div class="label"><i class="fas fa-fw fa-map-marked-alt"></i></div><input type="text" name="lokasifull" placeholder="Alamat..."> 
                    </div>
                    <div class="input">
                        <div class="label"><i class="fas fa-fw fa-link"></i></div><input type="text"  name="link" placeholder="Link Google Map..." > 
                    </div>
                    <div class="input">
                        <div class="label"><i class="fas fa-fw fa-ticket-alt"></i></div><input type="text" name="ket" placeholder="Tiket..." > 
                    </div>
                    <div class="input">
                        <div class="label"><i class="fas fa-fw fa-hashtag"></i></div><input type="text" name="hastag" placeholder="Hastag..." > 
                    </div>
                </div>
                <div class="content2">
            ...
            <button name="ubahdestinasi" class="ok">Tambah</button>
